...
\title{\textbf{Руководство пользователя Text Analyzer v1.0}}
...
\includegraphics[width=\textwidth]{screenshot_menu.png}

\subsection{Пакетный режим}
\includegraphics[width=\textwidth]{screenshot_batch.png}
